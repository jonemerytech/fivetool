  ...
  return (
    <section className="h-full bg-[url('/images/homeplate.webp')] bg-cover bg-center relative z-0">
      ...
      <div className="container mx-auto p-10">
        ...
        <div className="mt-20 flex flex-col justify-center items-center z-10 top-1/4 xl:grid xl:grid-cols-4 xl:grid-rows-1 xl:gap-2">
          <div className="w-64 h-72 bg-lightGray mt-3 opacity-90"></div>
          <div className="w-64 h-72 bg-lightGray mt-3 opacity-90"></div>
          <div className="w-64 h-72 bg-lightGray mt-3 opacity-90"></div>
          <div className="w-64 h-72 bg-lightGray mt-3 opacity-90"></div>
        </div>
